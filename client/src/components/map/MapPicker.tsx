...
export default function MapPicker({
  ...
  return (
    <div>
      <p className="mb-2 text-sm text-muted-foreground">Click on the map to pin the issue location</p>
      <MapContainer center={marker || { lat: 18.5204, lng: 73.8567 }} zoom={13} style={{ height: 300 }} className="z-0">
        <TileLayer
