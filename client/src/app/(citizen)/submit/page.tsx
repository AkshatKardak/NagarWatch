...
export default function CitizenSubmitComplaint() {
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-8 pt-24 min-h-screen space-y-6">
          ...
          <CardContent className="p-8 text-center space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-sm text-green-700">
                Your complaint <strong className="font-extrabold bg-green-100 px-2 py-0.5 rounded">#{submittedComplaintId?.slice(-6)}</strong> has been registered.
              </p>
            </div>
