      ...
      <div className="bg-white rounded-3xl border border-stone-200/80 p-6 sm:p-8 shadow-xs">
        <div className="mb-6 space-y-1">
          ...
          <p className="text-xs sm:text-sm text-slate-500 max-w-2xl leading-relaxed">
            Report road potholes, garbage accumulation, water leakages, or streetlights. Voice record in Hindi/Marathi/English, pin with What3Words, and get verified resolution.
          </p>
        </div>
